...
namespace Fusee.Engine
{
    ...
    */
    ...
    /// Clockwise and Counterclockwise culling refers to the order in which a triangle's vertices appear on the screen. If either is specified, triangles
    /// in the respective order are culled (not rendered).
    /// </summary>
    public enum Cull
    {
        None = 1,
